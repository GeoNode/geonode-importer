...
from importer.handlers.utils import create_alternate, drop_dynamic_model_schema, should_be_imported
...
class TestHandlersUtils(TestCase):
    ...
    def test_create_alternate_shuould_appen_an_hash(self):
        actual = create_alternate(
            layer_name="name", execution_id="1234"
        )
    ...
    def test_create_alternate_shuould_cut_the_hash_if_is_longer_than_63(self):
        actual = create_alternate(
            layer_name="this_is_a_really_long_name_for_a_layer_but_we_need_it_for_test_the_function", execution_id="1234"
        )
